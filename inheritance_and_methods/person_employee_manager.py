...
class Person:
    ...
    def greet(self):
        return "Hi, I'm " + self.name + ", age " + str(self.age)
...
class Employee(Person):
    ...
    def work_intro(self):
        return "I work at " + Employee.company + " as id " + self.emp_id
...
class Manager(Employee):
    ...
    def team_intro(self):
        return "I lead a team of " + str(len(self.team)) + " people."
...
print("Alice salary after 10% bonus :", e1.salary)
print("Bob salary after 10% bonus :", e2.salary)
print("Carol salary after 10% bonus :", m.salar
